...
iptables -A INPUT -p tcp -m tcp --dport 11443 -j REJECT 
iptables -A INPUT -p tcp -m tcp --dport 1112 -j REJECT 
iptables -A INPUT -p tcp -m tcp --dport 3013 -j REJECT 
iptables -A INPUT -p tcp -m tcp --dport 18081 -j REJECT 
iptables -A INPUT -p tcp -m tcp --dport 8088 -j REJECT 
iptables -A INPUT -p tcp -m tcp --dport 8086 -j REJECT 
iptables -A INPUT -p tcp -m tcp --dport 8085 -j REJECT 
iptables -A INPUT -p tcp -m tcp --dport 8080 -j REJECT 
iptables -A INPUT -p tcp -m tcp --dport 80 -j REJECT --reject-with icmp-port-unreachab
...
iptables -A OUTPUT -p tcp -m tcp --dport 11443 -j REJECT 
iptables -A OUTPUT -p tcp -m tcp --dport 1112 -j REJECT 
iptables -A OUTPUT -p tcp -m tcp --dport 3013 -j REJECT 
iptables -A OUTPUT -p tcp -m tcp --dport 18081 -j REJECT 
iptables -A OUTPUT -p tcp -m tcp --dport 8088 -j REJECT 
iptables -A OUTPUT -p tcp -m tcp --dport 8086 -j REJECT 
iptables -A OUTPUT -p tcp -m tcp --dport 8085 -j REJECT 
iptables -A OUTPUT -p tcp -m tcp --dport 8080 -j REJECT 
...
chmod 777 /data/data/DEIZZER/DEIZZER
sleep 2
exec /data/data/DEIZZER/DEIZZER LOGO
rm -rf /data/data/DEIZZER{START.sh,BGMI.sh,DEIZZER}
